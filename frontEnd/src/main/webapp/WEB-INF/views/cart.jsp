	...
	<div class="row">
		<c:if test="${empty(cartList)}">
			<div class="jumbotron">
				<h1>Cart Page</h1>
				<p>No Items</p>
				<a href="${contextroot}/ViewAllProduct" class="btn btn-default"> <span
				...
				<table class="table table-hover">
					...
					<tbody>
						<c:forEach items="${cartList}" var="c">
							<tr>
								<form action="${contextroot}/user/edititem?itemid=${c.itemid}" method="post">
									<td class="col-sm-8 col-md-6">
										<div class="media">
											<a class="thumbnail pull-left" href="#"> <img
												class="media-object"
												src="${CR}/${c.product.productId}.jpg"
									...
									<td class="col-sm-1 col-md-1"><a
										href="${contextroot }/user/removeitem?itemid=${c.itemid}" class="btn btn-danger">
						...
						<tr>
							<td>  <a href="${contextroot}/ViewAllProduct" class="btn btn-default">
