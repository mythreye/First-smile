...
<c:set var="cr4" value="${pageContext.request.contextPath}/seller" />
...
<c:choose>
	<c:when
		...
		<div id="flipkart-navbar">
			<div class="row row1">
				<ul class="largenav pull-right">
					<li class="upper-links"><a class="links" href="${contextroot}/home">Home</a></li>
					<li class="upper-links"><a class="links" href="${contextroot}/aboutus">About
							Us</a></li>
					<li class="upper-links"><a class="links" href="${contextroot}/ViewAllProduct">View
							All Product</a></li>
					<li class="upper-links"><a class="links" href="${contextroot}/contactus">Contact
							Us</a></li>


					<li class="upper-links"><a class="links" href="${cr1}/viewAllCart"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li class="lower-links"><a class="links"
									href="${cr1}/viewAllOrders">View Orders</a></li>
								<li class="lower-links"><a class="links" href="${cr1}/wishlist">WishList</a></li>
								 <li class="divider"></li>
								<li class="lower-links"><a class="links" href="${cr1}/userprofile">User
										Profile</a></li>
										
								<li class="lower-links"><a class="links"
									href="${cr1}/changepassword">Change Password</a></li>
								<li class="lower-links"><a class="links" href="${contextroot}/logout">Logout</a></li>
							</ul>
						</div>
				</li>
				</ul>
				...
				<div class="col-sm-2">
					<h2 style="margin: 0px;">
						<span class="smallnav menu" onclick="openNav()"><img
							src="${cr3}/resources/images/logo.PNG" class="img-responsive"></span>
					</h2>
					<h1 style="margin: 0px;">
						<span class="largenav"><img
							src="${cr3}resources/images/Capture.PNG" class="img-responsive"></span>
					</h1>
				</div>
		...
		<div id="mySidenav" class="sidenav">
			...
			<a href="${contextroot}/ViewAllProduct">View All Product</a>
		...
		<div id="flipkart-navbar">
			<div class="row row1">
				<ul class="largenav pull-right">
					...
					<li class="upper-links"><a class="links" href="${contextroot}/aboutus">About
							Us</a></li>
					<li class="upper-links"><a class="links" href="${cr4}/product">Product</a></li>
					<li class="upper-links"><a class="links" href="${contextroot}/contactus">Contact
							Us</a></li>
					...
					<div class="dropdown">
							...
							<ul class="dropdown-menu">
							<li class="lower-links"><a class="links" href="${cr4}/approveseller">Approve Order</a></li>
								<li class="lower-links"><a class="links" href="${cr4}/sellerprofile">Seller
										Profile</a></li>
									 <li class="divider"></li>	
								<li class="lower-links"><a class="links"
									href="${cr4}/changepassword">Change Password</a></li>
								<li class="lower-links"><a class="links" href="${contextroot}/logout">Logout</a></li>
		...
		<div id="flipkart-navbar">
			<div class="row row1">
				<ul class="largenav pull-right">
					...
					<li class="upper-links"><a class="links" href="${contextroot}/aboutus">About
							Us</a></li>
					<li class="upper-links"><a class="links" href="${cr2}/addCategory">Category</a></li>
					<li class="upper-links"><a class="links" href="${cr2}/viewSeller">Seller</a></li>
					<li class="upper-links"><a class="links" href="${contextroot}/contactus">Contact</a></li>
					...
					<li class="upper-links">Welcome!!
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
							<li class="lower-links"><a class="links" href="${cr2}/approveadmin">Delivery Orders</a></li>
								<li class="lower-links"><a class="links"
									href="${cr2}/changepassword">Change Password</a></li>
								<li class="lower-links"><a class="links" href="${contextroot}/logout">Logout</a></li>
							</ul>
