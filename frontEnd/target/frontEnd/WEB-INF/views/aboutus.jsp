        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="aboutus">
                        <h2 class="aboutus-title">About First Smile</h2>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="aboutus-banner">
                        <img src="https://www.washingtonpost.com/pbox.php?url=http://www.washingtonpost.com/blogs/wonkblog/files/2013/01/iStock_000009453427Small.png&w=340&op=resize&opt=1&filter=antialias&t=20170517" alt="">
                    </div>
                </div>
