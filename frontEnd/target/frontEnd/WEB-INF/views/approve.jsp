...
<div class="container">
	...
	<td>${pl.qty}</td>
	<td> <a href="approve?id=${pl.orderId}"> <span class="glyphicon glyphicon-ok" ></span> </a> || <a href="disapprove?id=${pl.orderId}"> <span class="glyphicon glyphicon-remove"></span> </a></td>
	</tr>
