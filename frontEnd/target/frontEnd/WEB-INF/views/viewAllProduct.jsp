			...
			<div class="card bg-light mb-3">
				...
				<ul class="list-group category_block">
					<c:forEach items="${Categories}" var="c">
						...
						<li class="list-group-item"><a href="cateproduct?cid=${c.categoryid}">${c.categoryname}</a></li>
					</c:forEach>
							...
							<div class="card-body">
								...
								<div class="row" style="padding-bottom:0">
									...
									<c:if test="${!empty(wishlist)}">
										...
										<a title="" href="removewishlist?id=${p.productId}" class="btn btn-outline-success"
											data-toggle="tooltip" data-original-title="Save to Wishlist">
											<i class="fa fa-heart bold"></i>
										</a>
										</c:if>
										<c:if test="${w.productid.productId!=p.productId}">
										<a title="" href="addwishlist?id=${p.productId}" class="btn btn-outline-success"
											data-toggle="tooltip" data-original-title="Save to Wishlist">
									...
									<div class="col-sm-5">
										...
										<a href="viewProduct?id=${p.productId}"
