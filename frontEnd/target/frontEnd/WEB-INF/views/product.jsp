				...
				<tbody>
					...
					<c:forEach items="${allProduct}" var="p">
						<tr>
							...
							<td><img src="resources/productimage/${p.productId}.jpg" class="img-responsive" height="50px"></td>
							<c:url value="updateProduct?pid=${p.productId}" var="cid"></c:url>
							<c:url value="deleteProduct?pid=${p.productId}" var="deleteid"></c:url>
							<td><a href="${cid}"><span
